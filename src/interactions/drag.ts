...
import { move_element, notify } from "../api.js";
import draw from "../core/draw.js";
import zoomHandler from "../main.js";
import { log } from "../core/log.js";
import { View } from "../views/view.js";

let draggedElement: View | null;
...
export function enddrag(event: PointerEvent)
{
    ...
    diagview.move(draggedElement.id, xPosition, yPosition, {final: true});
    draw();
    draw();
