...
import { attach_to_grid, grid_size } from "../core/grid.js";
import LineView, { BendPoint } from "../lines/line-view.js";
import { log } from "../core/log.js";
import zoomHandler from "../main.js";
import { CustomPointer } from "./mouse-event.js";
import { ELEMENT_HEIGHT } from "../core/styles.js";

let currentBendpointId: string;
let currentLine:LineView|null = null;
...
export function endbend(event: PointerEvent, pointer: CustomPointer)
{
    ...
    try {
        ...
        let xPosition = currentLine?.getBendpoint(currentBendpointId).x || 0;
        let yPosition = currentLine?.getBendpoint(currentBendpointId).y || 0;
