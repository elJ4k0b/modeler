...
class ZoomHandler
{
    ...
    public svg_viewport: HTMLElement;
    ...
    constructor()
    {
        ...
        this.svg_viewport = document.getElementById("svg-viewport") as HTMLElement || document.createElementNS("http://www.w3.org/2000/svg", "svg");
    ...
    _applyMatrix(element: HTMLElement, matrix: WebKitCSSMatrix)
    {
        try {
            ...
            let svg_viewportMatrix = `matrix(${this.zoomFactor}, 0, 0, ${this.zoomFactor}, ${DEFAULT_VIEWPORT_OFFSET * this.zoomFactor + this.viewportCenter.x}, ${DEFAULT_VIEWPORT_OFFSET * this.zoomFactor + this.viewportCenter.y})`;
            this.svg_viewport.setAttribute("transform", svg_viewportMatrix);
        }catch (error)
        {
