...
import LineView, { BendPoint } from "./line-view.js";
...
export class LineVisual
{
    ...
    protected get TOUCHAREA_STROKE_WIDTH(): string { return "60"; }
    ...
    private _create_marker(markerTargetIsSelected: boolean): SVGMarkerElement
    {
